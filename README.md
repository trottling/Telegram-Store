...
- 📈 Логи и метрики всего стека в Grafana (`stats.$DOMAIN_NAME`) — вход тем же кодом из `/admin`, отдельного логина нет; два дашборда — технический (эксплуатация) и бизнесовый (выручка, пополнения, регистрации, топ товаров)
